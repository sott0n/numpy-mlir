// RUN: npc-opt -split-input-file -verify-diagnostics %s | npc-opt -canonicalize | FileCheck --dump-input=fail %s

//===----------------------------------------------------------------------===//
// func.func_template_call
//===----------------------------------------------------------------------===//

// CHECK-LABEL: func.func @positional
func.func @positional(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
...
// -----
// CHECK-LABEL: func.func @kwValid
func.func @kwValid(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
...
// -----
// CHECK-LABEL: func.func @posArgPack
func.func @posArgPack(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
  // CHECK: basicpy.func_template_call @foobar(%arg0, %arg1) kw ["*"]
  %0 = basicpy.func_template_call @foobar(%arg0, %arg1) kw ["*"] : (!basicpy.UnknownType, !basicpy.UnknownType) -> !basicpy.UnknownType
  return %0 : !basicpy.UnknownType
}
...
// -----
// CHECK-LABEL: func.func @kwArgPack
func.func @kwArgPack(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
  // CHECK: basicpy.func_template_call @foobar(%arg0, %arg1) kw ["**"]
  %0 = basicpy.func_template_call @foobar(%arg0, %arg1) kw ["**"] : (!basicpy.UnknownType, !basicpy.UnknownType) -> !basicpy.UnknownType
  return %0 : !basicpy.UnknownType
}
...
// -----
func.func @kwOverflow(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
...
// -----
func.func @badPosArgPack(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
...
// -----
func.func @badKwArgPack(%arg0 : !basicpy.UnknownType, %arg1 : !basicpy.UnknownType) -> !basicpy.UnknownType {
...
module @valid_template {
  ...
  basicpy.func_template @__global$pkg.foobar attributes {py_bind = ["#abs"]} {
    // CHECK: func.func @forInts(%arg0: i32) -> i32
    func.func @forInts(%arg0 : i32) -> i32 {
      return %arg0 : i32
    }
  }
}

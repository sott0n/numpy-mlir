...
func.func @slot_object_make() -> (!basicpy.SlotObject<slice, !basicpy.NoneType, !basicpy.NoneType, !basicpy.NoneType>) {
...
// CHECK-LABEL: @slot_object_get
func.func @slot_object_get() -> (!basicpy.NoneType) {
  %0 = basicpy.singleton : !basicpy.NoneType

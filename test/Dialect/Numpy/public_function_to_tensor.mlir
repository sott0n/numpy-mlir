// RUN: npc-opt -split-input-file %s -verify-diagnostics -allow-unregistered-dialect -numpy-public-functions-to-tensor | FileCheck --dump-input=fail %s

// -----
// CHECK-LABEL: @legalConversion
module @legalConversion {
  func.func @f(%arg0 : !numpy.ndarray<[3,?]:f32>, %arg1 : i32, %arg2 : !numpy.ndarray<*:f32>) ->
...
module @nonPublic {
  ...
  func.func private @f(%arg0 : !numpy.ndarray<[3,?]:f32>) -> (!numpy.ndarray<[3,?]:f32>) {
...
module @called {
  ...
  func.func @f(%arg0 : !numpy.ndarray<*:f32>) -> !numpy.ndarray<*:f32> {
    return %arg0 : !numpy.ndarray<*:f32>
  }

  func.func private @caller(%arg0 : !numpy.ndarray<*:f32>) -> !numpy.ndarray<*:f32> {
